...
builder.Host.UseWolverine(opts =>
{
    ...
    //opts.Services.Configure<RabbitMQConnectionLimits>(limits =>
    //{
    //    limits.MaxConnectionRetryCount = 5;     // 重试 5 次
    //    limits.ConnectionRetryDelay = TimeSpan.FromSeconds(2);  // 间隔 2 秒
    //    limits.HeartbeatInterval = TimeSpan.FromSeconds(60);    // 心跳延长，避免闲置断开
    //});
